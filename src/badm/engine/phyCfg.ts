...
export class PhyCfg {
    ...
    map: MPMD; readonly GRID = 10; readonly MAX_LOOKBACK = 10; maxCache = 200000;
    ...
    public clearCache() { this.map.clear(); this.map.addByTime(this.state.time, this.state.clone()); this.resetDbg(); }
    public resetDbg() {
